...
option = st.sidebar.radio("Select One", ["Home", "AUTO Generate Key Insides", "Ask AI Data Assistant with Voice or Chat ", "Data Summary With ai voice", "Statistical Analysis With Voice ", "Visualization"])
...
if uploaded_file is not None: 
    ...
    # Ask AI Data Assistant with Voice or Chat
    # ==========================
    elif option == "Ask AI Data Assistant with Voice or Chat":
        st.header("🤖 Ask AI")
    ...
    # Data Summary With ai voice
    # ==========================
    elif option == "Data Summary With ai voice":
        st.divider()
    ...
    # Statistical Analysis With Voice 
    # ==========================
    elif option == "Statistical Analysis With Voice":
